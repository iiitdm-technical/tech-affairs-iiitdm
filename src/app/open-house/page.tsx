...
const awards = [
    ...
    { recipient: 'Cybersecurity Club', recognition: 'Rising Tech Force', icon: '🛡️', color: C.cyan, gradient: `linear-gradient(135deg, ${C.cyan}20, ${C.violet}10)`, borderColor: `${C.cyan}30` },
    { recipient: 'Smart Sense', recognition: 'Intelligent Systems & Innovation', icon: '🧠', color: C.blue, gradient: `linear-gradient(135deg, ${C.blue}20, ${C.cyan}10)`, borderColor: `${C.blue}30` },
...
const bodies = [
    ...
    { name: 'Smart Sense', desc: 'Sensors, IoT & Intelligent Systems', logo: '/clubs/smartsense/logo.svg', route: '/clubs/smart-sense', cat: 'Clubs' },
