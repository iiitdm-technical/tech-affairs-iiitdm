...
const TeamCard = styled(Card)(({ theme }) => ({
  ...
  textAlign: "center",
  borderRadius: 18,
  background: theme.palette.mode === "dark" ? "rgba(9,19,38,0.75)" : "rgba(255,255,255,0.85)",
  border: `1px solid ${theme.palette.mode === "dark" ? "rgba(125,211,252,0.1)" : "rgba(51,73,132,0.14)"}`,
  boxShadow: "none",
...
const TAB_META = [
  { label: "Clubs",       category: "club",      route: "clubs",       color: "#7dd3fc" },
  { label: "Teams",       category: "team",      route: "teams",       color: "#93c5fd" },
      ...
      <Container maxWidth="lg">
        ...
        <Tabs
          ...
          sx={{
            mb: 3,
            borderRadius: 3,
            bgcolor: isDark ? 'rgba(9,19,38,0.75)' : 'rgba(255,255,255,0.9)',
            border: `1px solid ${isDark ? 'rgba(125,211,252,0.14)' : 'rgba(51,73,132,0.17)'}`,
            boxShadow: 'none',
            minHeight: 36,
            mx: "auto",
            width: "100%",
            "& .MuiTabs-indicator": {
              background: `linear-gradient(90deg, ${currentColor}, #93c5fd)`,
              height: 3,
              borderRadius: 2,
            },
          }}
                ...
                >
                  <Box
                    sx={{
                      ...
                      height: { xs: 70, sm: 85 },
                      mb: 1,
                      bgcolor: isDark ? 'rgba(125,211,252,0.06)' : 'rgba(51,73,132,0.05)',
                      borderRadius: 3.5,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      border: `1px solid ${isDark ? 'rgba(125,211,252,0.1)' : 'rgba(51,73,132,0.13)'}`,
                      overflow: "hidden",
                      p: 1,
                      position: "relative",
                    }}
