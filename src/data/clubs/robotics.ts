  ...
  timeline: [
    {
      year: 2024,
      event: "Flipkart Grid",
      description: "Developed a pick-and-place robot for package identification. Progressed to Round 2, achieving a ranking of 66th across India.",
    },
    {
      year: 2024,
      event: "TechnoXian Robowars",
      description: "Designed and built a 15Kg combat robot. Placed 22nd out of all competitors across India.",
    },
    {
      year: 2024,
      event: "VIT graVITas Robowars",
      description: "Participated in both 8Kg and 15Kg combat robot categories at VIT Vellore.",
    },
    {
      year: 2024,
      event: "IIT Bombay Techfest",
      description: "Competed in 8Kg and 15Kg Robowars categories at IIT Bombay Techfest 2024.",
    },
    {
      year: 2025,
      event: "IIT Madras Shaastra",
      description: "Participated in the 15Kg Robowars category at IIT Madras Shaastra 2025.",
    },
    {
      year: 2025,
      event: "SamgathaxVasisth Fest",
      description: "Successfully organized Line Follower and Robowars events with a prize pool of Rs.45,000 and over 12 teams participating.",
    },
  ],
  projects: [
    {
