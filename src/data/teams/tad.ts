...
const data: ClubPageData = {
  ...
  timeline: [
    ...
    },
    {
      ...
      description: "Finished top 30's at South Zone of National Aeromodelling Competition 2025.",
    },
    {
      year: 2024,
  ...
  projects: [
    {
      ...
      description: "Designed fixed-wing aircraft with varied fuselage shapes and internal structures to analyse aerodynamic and structural performance.",
    ...
    },
    {
      ...
      description: "Designing a modular VTOL UAV with hybrid thrust configuration, validated through MATLAB/Simulink-based control simulations.",
      image: "/teams/tad/logo.webp",
    ...
    },
    {
      ...
      description: "Engineered a high-lift wing aircraft with flap mechanisms for enhanced payload capacity.",
      technologies: ["Control Systems", "Embedded Systems", "Flight Dynamics"],
      themeColor: "#FB8C00",
    },
    {
      name: "Modular-Wing Glider (2025)",
      description: "Built a glider with interchangeable wings and tail modules for aerodynamic experimentation.",
      technologies: ["Control Systems", "Embedded Systems", "Flight Dynamics"],
      themeColor: "#FB8C00",
    },
  ],
  gallery: [
    { src: "/teams/tad/gallery/plane1.jpeg", caption: "" },
    { src: "/teams/tad/gallery/plane2.jpeg", caption: "" },
    { src: "/teams/tad/gallery/team.jpeg",   caption: "" },
