...
const data: ClubPageData = {
  ...
  projects: [
    {
      ...
      description: "Currently working on ISRO IRoC U 2026 Qualification Round. For this round, we need to submit a detailed proposal report and video demonstration. The deadline for this challenge is 02.04.2026.",
  ...
  gallery: [
    { src: "/teams/astra/a2.webp", caption: "Autonomous drone prototype developed by Team Astra" },
    { src: "/teams/astra/a1.webp", caption: "Team Astra members preparing the drone for testing" },
    { src: "/teams/astra/a3.webp", caption: "Drone flight testing session" },
    { src: "/teams/astra/a5.webp", caption: "Team Astra members preparing the drone for testing" },
    { src: "/teams/astra/a6.webp", caption: "Team Astra members preparing the drone for testing" },
    { src: "/teams/astra/a4.webp", caption: "Team Astra members preparing the drone for testing" },
    { src: "/teams/astra/a8.webp", caption: "Team Astra members preparing the drone for testing" },
  ],
  core: [
    {
      name: "Vigesh V S",
